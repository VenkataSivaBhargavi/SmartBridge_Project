...
import pandas as pd
app = Flask(__name__)
model = pickle.load(open(r"C:\Users\venka\OneDrive\Desktop\project\model.pkl", 'rb'))
scaler = pickle.load(open(r"C:\Users\venka\OneDrive\Desktop\project\scale.pkl", 'rb'))
